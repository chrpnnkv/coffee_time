...
from ui_addEditCoffeeForm import Ui_addForm
from ui_main import Ui_mainForm

DB = '../data/coffee.sqlite'

class CoffeeWidget(QWidget, Ui_mainForm):
    def __init__(self):
        super().__init__()
        self.setupUi(self)

        self.cur = sqlite3.connect(DB).cursor()
...
class EditWidget(QWidget, Ui_addForm):
